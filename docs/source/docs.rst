...
We use Sphinx to render, and readthedocs.org to publish, Huhi Browser
documentation. You can view the latest documentation at `https://huhisoft.comlatest/ <https://huhisoft.comlatest/>`_.

Contributing to Huhi Browser documentation can be done by editing the
``docs/source/*.rst`` files in the `huhi-browser repository <https://github.com/huhisoft/huhi-browser>`_
...
``huhi-browser/docs/build/html/index.html``.
...
We have a project for the `huhi-browser repository <https://github.com/huhisoft/huhi-browser>`_
already setup on readthedocs.org. You can view the latest documentation at
`https://huhisoft.comlatest/ <https://huhisoft.comlatest/>`_.

By default, `readthedocs <http://huhi-browser.readthedocs.io/>`_
